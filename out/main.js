// Generated by Haxe 4.0.0-preview.5+da718a30e
(function () { "use strict";
...
coconut_diffing_Differ.prototype = {
	...
	,mountInstance: function(w,parent,later) {
		if(w._coco_alive) {
			throw new js__$Boot_HaxeError("Same widget instance mounted twice " + Std.string(w));
		}
...
coconut_vdom__$Child_Child_$Impl_$.ofNode = function(n) {
...
coconut_vdom__$Child_Child_$Impl_$.renderInto = function(this1,target) {
	coconut_ui_Renderer.mount(target,this1);
};
var coconut_diffing_VNodeData = $hxEnums["coconut.diffing.VNodeData"] = { __ename__ : true, __constructs__ : ["VNativeInst","VWidgetInst","VMany","VNative","VWidget"]
	,VNativeInst: ($_=function(n) { return {_hx_index:0,n:n,__enum__:"coconut.diffing.VNodeData"}; },$_.__params__ = ["n"],$_)
	,VWidgetInst: ($_=function(w) { return {_hx_index:1,w:w,__enum__:"coconut.diffing.VNodeData"}; },$_.__params__ = ["w"],$_)
	,VMany: ($_=function(nodes) { return {_hx_index:2,nodes:nodes,__enum__:"coconut.diffing.VNodeData"}; },$_.__params__ = ["nodes"],$_)
	,VNative: ($_=function(type,ref,key,a,children) { return {_hx_index:3,type:type,ref:ref,key:key,a:a,children:children,__enum__:"coconut.diffing.VNodeData"}; },$_.__params__ = ["type","ref","key","a","children"],$_)
	,VWidget: ($_=function(type,ref,key,a,t) { return {_hx_index:4,type:type,ref:ref,key:key,a:a,t:t,__enum__:"coconut.diffing.VNodeData"}; },$_.__params__ = ["type","ref","key","a","t"],$_)
};
...
CocosDatePicker.prototype = $extend(coconut_ui_View.prototype,{
	...
	,onOuterClick: function(e) {
		if(this.picker.current != e.target && this.input.current != e.target) {
			this.unregisterBodyClick();
			this.hidePicker();
		}
	}
	,registerBodyClick: function() {
		window.document.addEventListener("click",$bind(this,this.onOuterClick));
	}
	,unregisterBodyClick: function() {
		window.document.removeEventListener("click",$bind(this,this.onOuterClick));
	}
	,showPicker: function() {
	...
	,hidePicker: function() {
		this.picker.current.style.display = "none";
	}
	,render: function() {
		var _gthis = this;
		var __r = [];
		...
		var __r3 = [];
		var __ret4 = { className : tink_domspec__$ClassName_ClassName_$Impl_$.ofString("left")};
		var __r4 = [];
...
var coconut_diffing_RNode = $hxEnums["coconut.diffing.RNode"] = { __ename__ : true, __constructs__ : ["RNative","RWidget"]
	,RNative: ($_=function(a,r,ref) { return {_hx_index:0,a:a,r:r,ref:ref,__enum__:"coconut.diffing.RNode"}; },$_.__params__ = ["a","r","ref"],$_)
	,RWidget: ($_=function(w,ref) { return {_hx_index:1,w:w,ref:ref,__enum__:"coconut.diffing.RNode"}; },$_.__params__ = ["w","ref"],$_)
};
...
coconut_ui__$Ref_RefSetter_$Impl_$.__name__ = true;
coconut_ui__$Ref_RefSetter_$Impl_$.ofSetter = function(r) {
	return r.setter;
};
...
coconut_vdom_Html.raw = function(attr) {
	return coconut_vdom__$Html_HtmlFragment.fromHxx(attr);
};
...
var coconut_vdom__$Html_HtmlFragment = function(__coco_data_) {
	var _gthis = this;
	this.__tink_defaults3 = { tag : tink_state__$Observable_Observable_$Impl_$["const"]("span"), className : null};
	...
	var snapshot = null;
	var viewDidMount = function() {
		var viewDidMount1 = tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.tag);
		_gthis.lastContent = viewDidMount1;
		var viewDidMount2 = tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.content);
		_gthis.root.innerHTML = _gthis.lastContent = viewDidMount2;
	};
	var viewDidUpdate = function() {
		if(_gthis.lastContent != tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.content) || _gthis.lastTag != tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.tag)) {
			...
			_gthis.root.innerHTML = viewDidUpdate1;
			var viewDidUpdate2 = tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.content);
			_gthis.lastContent = viewDidUpdate2;
			var viewDidUpdate3 = tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.tag);
			_gthis.lastTag = viewDidUpdate3;
		}
	};
...
coconut_vdom__$Html_HtmlFragment.fromHxx = function(attributes) {
	return coconut_vdom__$Child_Child_$Impl_$.widget("coconut.vdom._Html.HtmlFragment",attributes.key,attributes.ref,attributes,{ create : function(__coco_data_) {
...
coconut_vdom__$Html_HtmlFragment.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
		var _gthis = this;
		return coconut_vdom__$Child_Child_$Impl_$.element(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.tag),{ className : tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.className), ref : function(e) {
			_gthis.root = e;
		}},null);
	}
	,viewDidMount: function() {
		this.lastContent = tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.tag);
		var tmp = tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.content);
		this.root.innerHTML = this.lastContent = tmp;
	}
	,viewDidUpdate: function() {
		if(this.lastContent != tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.content) || this.lastTag != tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.tag)) {
			var tmp = tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.content);
			this.root.innerHTML = tmp;
			this.lastContent = tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.content);
			this.lastTag = tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.tag);
		}
	}
	...
	,__initAttributes: function(attributes) {
		...
		this.__slots.tag.setData(this1 == null ? this.__tink_defaults3.tag : this1);
		var this2 = attributes.className;
		this.__slots.className.setData(this2 == null ? this.__tink_defaults3.className : this2);
	}
});
