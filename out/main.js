// Generated by Haxe 4.0.0-preview.5+83d9c11a2
(function () { "use strict";
...
CocosDatePicker.prototype = $extend(coconut_ui_View.prototype,{
	...
	,onDayClick: function(day) {
		console.log("src/CocosDatePicker.hx:105:",day);
	}
	,onLeftClick: function() {
		...
		console.log("src/CocosDatePicker.hx:116:",tink_state__$State_State_$Impl_$.get_value(this.__coco_currentDate));
	}
	...
	,onRightClick: function() {
		...
		var param = new Date(year,month + 1,1,0,0,0);
		this.__coco_currentDate.set(param);
		console.log("src/CocosDatePicker.hx:134:",tink_state__$State_State_$Impl_$.get_value(this.__coco_currentDate));
	}
	,render: function() {
		var _gthis = this;
		...
		var __r10 = [];
		var _g1 = 0;
		while(_g1 < days.length) {
			var day1 = [days[_g1]];
			++_g1;
			var __ret11 = { className : tink_domspec__$ClassName_ClassName_$Impl_$.ofString("day"), onclick : (function(day2) {
				return function(event) {
					_gthis.onDayClick(day2[0]);
				};
			})(day1)};
			var __r11 = [];
			__r11.push(coconut_vdom__$Child_Child_$Impl_$.ofInt(day1[0].day));
...
DateManager.prototype = {
	getMonthDays: function(month,year) {
		...
		while(_g1 < _g2) {
			var day = _g1++;
			_g.push({ day : day, month : month, year : year});
		}
		var res = _g;
		return res;
	}
